...
{
    verticesOfOrignalLine << 1.0 << 1.0 <<0.0;
    verticesOfOrignalLine << 2.0 << 1.0 <<0.0;

    verticesOfOrignalLine << 2.0 << 1.0 << 0.0;
    verticesOfOrignalLine << 2.0 << 2.0 <<0.0;

    verticesOfOrignalLine << 2.0 << 2.0 << 0.0;
    verticesOfOrignalLine << 1.0 << 2.0 <<0.0;
    ...
    verticesOfOrignalLine << 5.0 << 4.0 << 0.0;

    verticesOfOrignalLine << 5.0 << 4.0 << 0.0;
    verticesOfOrignalLine << 5.0 << 5.0 << 0.0;
    ...
    verticesOfOrignalLine << 11.0 << 10.0 << 0.0;
    verticesOfOrignalLine << 11.0 << 11.0 << 0.0;

    verticesOfOrignalLine << 11.0 << 11.0 << 0.0;
    verticesOfOrignalLine << 10.0 << 11.0 << 0.0;
...
{
    colorOfOrignalLine << 1.0 << 1.0 << 1.0;
    colorOfOrignalLine << 1.0 << 1.0 << 1.0;
    colorOfOrignalLine << 1.0 << 1.0 << 1.0;
    colorOfOrignalLine << 1.0 << 1.0 << 1.0;
    colorOfOrignalLine << 1.0 << 1.0 << 1.0;
